...
arc_score: 6
---
# 🦅 VT (Vetus Testamentum) (2025) Theological Digest

> [!INFO] Intelligence Summary
> 본 보고서는 **theo-trend-nexus** 5D 분석 엔진을 통해 생성된 VT (Vetus Testamentum) 저널의 2025년호 요약입니다.
...
- **Analytical Tags**: `OT / - / -`
- **Abstract**: Abstract
Two anthologies on the anthropology of the mind have appeared in the last years: J. Dietrich, Hebräisches Denken. Denkgeschichte und Denkweisen des Alten Testaments (BThSt 191; Göttingen Vandenhoeck & Ruprecht, 2022) and J. van Oorschot / L. Allolio-Näcke / A. Wagner, Archaeology of Mind in the Hebrew Bible / Archäologie alttestamentlichen Denkens (Berlin/Boston: De Gruyter, 2023). This contribution embeds them in the more recent developments in the study of thought, mentality, and concepts of personhood in ancient Israel.
...
### Front matter
- **DOI**: [10.1163/15685330-07501000](https://doi.org/10.1163/15685330-07501000)
- **Analytical Tags**: `- / - / -`
- **Abstract**: No abstract available
...
### Back matter
- **DOI**: [10.1163/15685330-07504-05015](https://doi.org/10.1163/15685330-07504-05015)
- **Analytical Tags**: `- / - / -`
- **Abstract**: No abstract available
...
- **Analytical Tags**: `OT / - / -`
- **Abstract**: Abstract
This essay argues that Amos 3:7 was interpolated into Amos 3:3–8 to create an intertextual link with Jer 23:16–22. While the Amos and Jeremiah passages already displayed some lexical and thematic similarities, the addition of Amos 3:7 and its use of sôd strengthened those connections. As a result, the author of Amos 3:7 invites readers to interpret Amos while contemplating Jeremiah’s comments on legitimate prophets.
...
- **DOI**: [10.1163/15685330-bja10199](https://doi.org/10.1163/15685330-bja10199)
- **Analytical Tags**: `- / - / -`
- **Abstract**: Abstract
This paper deals with several metaphors found in the Hebrew text of Ben Sira that are grounded in the conceptual metaphor that people are plants. The article analyzes three distinct categories of individuals: the righteous (50:8, 10), the wicked (10:16–17; 40:15–16), and the disciple of wisdom (3:9; 6:2–3). The botanical source domain and its associated framework are mapped onto the target domain of these types of individuals, thereby structuring much of our understanding of how the Hebrew text of Ben Sira distinguishes them.
...
- **DOI**: [10.1163/15685330-bja10201](https://doi.org/10.1163/15685330-bja10201)
- **Analytical Tags**: `- / - / -`
- **Abstract**: Abstract
Psalm 145 is an alphabetic acrostic whose main theme is the praise of God. Watson suggested an acrostic of the word מלך “king” in the psalm. This paper suggests another pattern in Ps 145—a telestic that mentions the name David twice in a symmetrical manner. Thus, the two non-alphabetic patterns in Ps 145 form the name and title of King David. An additional bidirectional telestic of the word הודו “praise” is also discussed, as well as the 11QPsa and LXX versions of the psalm.

---

### Die Vetus Latina der Klagelieder als Zeugin für den Bedeutungswandel hebräischer Lexeme im Licht ihrer aramäischen Umwelt
- **DOI**: [10.1163/15685330-bja10202](https://doi.org/10.1163/15685330-bja10202)
- **Analytical Tags**: `OT / - / -`
- **Abstract**: Abstract
The fragments of the Vetus Latina are rightly regarded as valuable witnesses for the reconstruction of the original text of the Septuagint (OG). Only a few texts are available for the book of Lamentations. This study builds on a thesis of Orientalist Anton Baumstark, who has claimed an Aramaic influence for the Old Latin text of Hab 3. Similarly, the various fragments of Lamentations are characterized by several special readings that reflect the Aramaic linguistic world, especially of the Targumim. However, a direct dependence on the Targumim cannot be assumed. In the course of the LXX transmission, many of these readings preserved by the VL were adapted to the Hebrew understanding of the language and thus disappeared from the LXX texts. Finally, it is notable that many of the special readings of the VT with an Aramaic background also agree with the Antiochene text group. Since this text group is particularly close to the Syriac-Aramaic language world, this confirms the thesis.
...
- **Analytical Tags**: `- / - / -`
- **Abstract**: Abstract
The word תבנית in Hebrew derives from the Akkadian tabnītu, and in its earliest occurrences seems to mean simply “image.” Its negative connotations in passages belonging to the Deuteronomistic tradition are apparently due to the anti-idolatrous context. In later texts, it appears with the specialized meaning of “architectural drawings.” In P and post-P passages, this meaning was theologized into the metaphysical sense of “prototype,” possibly under the influence of the Iranian concept of ratuš.

---

### Qualified Continuity
- **DOI**: [10.1163/15685330-bja10208](https://doi.org/10.1163/15685330-bja10208)
- **Analytical Tags**: `OT / - / -`
- **Abstract**: Abstract
The account of the fall of Jerusalem in Chronicles mentions the despoliation of the temple vessels. In contrast to its Vorlage (2 Kgs 24–25), Chronicles is filled with a sense of forward-looking continuity; the cultic paraphernalia serve as a symbol of the postexilic restoration. Yet, according to 2 Chr 36, that continuity does not extend backward; the vessels taken to Babylon were not those produced under Solomon. To explain the discrepancy with 2 Kgs 24–25, the article discusses the Chronicler’s understanding of idolatry and studies its effects. The comparison between the accounts of the reforms of Jehoash and Hezekiah shows that, for the Chronicler, the misuse of the temple vessels in the ritual worship of foreign deities demands their substitution. Probing the reason for this, the article proposes that the Chronicler could have been influenced by an exegetical tradition that promoted a more stringent interpretation of Deut 7:25.

---

### A TEL of No City
- **DOI**: [10.1163/15685330-bja10209](https://doi.org/10.1163/15685330-bja10209)
- **Analytical Tags**: `- / - / -`
- **Abstract**: Abstract
This paper critically examines the widely accepted Tel-Aviv model concerning Ezekiel’s life in Babylonia and instead advocates for an urban context for the exiled intellectual. It further challenges the association of the Hebrew תל אביב (Tel-Aviv) with the Babylonian toponym Til-abūbe, arguing that the reading of this toponym in UET 4 111 is untenable. The collapse of the Tel-Aviv model necessitates a reassessment of Ezekiel’s Tel-Aviv, concluding that it was likely never intended as a toponym. Instead, while indeed derived from the Akkadian phrase til abūbe, it is more plausibly understood as an apposition to the exilic community (Gola), symbolising the desolation faced by the Judean exiles.

---

### The Judgments of the Israelite and Judahite Kings in Diachronic and Historical Perspective
- **DOI**: [10.1163/15685330-bja10210](https://doi.org/10.1163/15685330-bja10210)
- **Analytical Tags**: `- / - / -`
- **Abstract**: Abstract
...
- **Analytical Tags**: `- / - / -`
- **Abstract**: Abstract
The phrase ומבין חידות in Dan 8:23 has been variously interpreted as “adept in duplicity,” “skilled in trickery,” “skilled in understanding riddles,” or “expert at enigmas.” While scholars focus on the meaning of the phrase, they overlook its literary features. In this article, I argue that the phrase ומבין חידות is not only a characteristic of the little horn, but also part of the literary contrast between divine wisdom and the wisdom of an earthly ruler in Dan 8. A contrast between the little horn’s understanding (Dan 8:23) and Daniel’s lack of understanding (Dan 8:15–17, 27) creates a contradictory picture of the superiority of human wisdom, which finds its development and resolution in a parallel vision (Dan 10–12). Furthermore, I argue that this contrast is part of a larger contrast that occurs at the level of the literary structure of the entire book.
...
- **DOI**: [10.1163/15685330-bja10223](https://doi.org/10.1163/15685330-bja10223)
- **Analytical Tags**: `OT / - / -`
- **Abstract**: Abstract
...
- **Analytical Tags**: `OT / - / -`
- **Abstract**: Abstract
The near ubiquitousness of Zion in the Hebrew Bible has been well noted. The same is true in the case of the book of Isaiah. As such, Zion’s prospect across this prophetic book continues to elicit scholarly interest. The present work focuses on two Zion occurrences that portray (i) her taunting act (Isa 37:22) and (ii) her words of tirade (49:14). A re-reading of these two portrayals, particularly from Social Identity sensibilities, help highlight some identity-negotiating aspects, honor-instilling mechanism, and the value of protesting voices for the meaning-making process.

---

### Tithes and Imperial Taxes
- **DOI**: [10.1163/15685330-bja10232](https://doi.org/10.1163/15685330-bja10232)
- **Analytical Tags**: `- / - / -`
- **Abstract**: Abstract
                  This paper focuses on the regulations concerning tithes appearing in Neh 10:38–40. These verses raise several exegetical and practical questions: Why are the tithes being taken by the Levites themselves in the rural areas and not delivered to the temple by the Israelites like the rest of the contributions mentioned in the pledge? What is the meaning and function of the “vessels of the temple” in their context?
                  Following a discussion of different scholarly treatments of these questions, it will be proposed that the answer to them (and a different understanding of the Levites’ role) lies in a Mesopotamian imperial tax-collecting custom from both the Neo-Babylonian and Persian periods. Contemporaneous cuneiform documents indicate this custom’s prevalence and its impact on the lives of the Judean exiles in Babylonia. Hence, it is most likely that it is also the background of Neh 10:38–40.

---

### Measuring Conceptual Complexification in the Pentateuch
- **DOI**: [10.1163/15685330-bja10233](https://doi.org/10.1163/15685330-bja10233)
- **Analytical Tags**: `OT / - / -`
- **Abstract**: Abstract
...
- **DOI**: [10.1163/15685330-bja10234](https://doi.org/10.1163/15685330-bja10234)
- **Analytical Tags**: `- / - / -`
- **Abstract**: Abstract
